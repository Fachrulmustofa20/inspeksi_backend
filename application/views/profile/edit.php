                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0 p-0">
                            <li class="breadcrumb-item"><a href="<?= base_url('dashboard'); ?>" class="text-muted">Menu</a></li>
                ...
                <div class="card">
                    <div class="card-body">
                        <center class="m-t-30"> <img src="<?= base_url('assets/img/profile/') . $user['image']; ?>" alt="image" class="rounded-circle" width="150">
                            ...
                            <h5 class="text-center mb-3">NIP : <?= $user['nip']; ?></h5>
                            <h5 class="card-subtitle"><?= $user['role_id'] == 1 ? "Administrator" : "Penguji"; ?></h5>

                            <div class="row text-center justify-content-md-center">
                                <div class="col-12">Buat Akun :</div>
                            </div>
                            <div class="row text-center justify-content-md-center">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-horizontal form-material">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" class="form-control form-control-line" name="nip" value="<?= $user['nip']; ?>">
